...
use astrolend::constants::PYTH_ID;
use astrolend::constants::SWITCHBOARD_PULL_ID;
...
pub fn get_emissions_authority_address(bank_pk: Pubkey, emissions_mint: Pubkey) -> (Pubkey, u8) {
    Pubkey::find_program_address(
        &[
            astrolend::constants::EMISSIONS_AUTH_SEED.as_bytes(),
            bank_pk.as_ref(),
...
pub fn get_emissions_token_account_address(
    ...
    Pubkey::find_program_address(
        &[
            astrolend::constants::EMISSIONS_TOKEN_ACCOUNT_SEED.as_bytes(),
            bank_pk.as_ref(),
            emissions_mint.as_ref(),
        ],
        &astrolend::id(),
