 ...
 * IDL can be found at `target/idl/astrolend.json`.
 */
export type Astrolend = {
  ...
  "instructions": [
    ...
    {
      "name": "astrolendAccountInitialize",
      "docs": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "liquidatorAstrolendAccount",
          "writable": true
        },
        {
          "name": "signer",
  ...
  "types": [
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "astrolendAccountAuthority",
            "type": "pubkey"
          },
          {
            "name": "astrolendGroup",
